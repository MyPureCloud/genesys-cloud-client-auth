...
import { EmbeddedAppState, getEmbeddedAppState, getPreAuthFlowHref } from './utils';


export const handlePopupWindowRedirect = (storage: Storage, authData: IAuthData) : EmbeddedAppState => {
